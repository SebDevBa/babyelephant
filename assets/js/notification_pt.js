...
var facts = ['50% LIQUIDEZ','10% FEE','CARTEIRAS DEVS','PROJETO','CICLO CONTÍNUO','PROJETO','+CONFIANÇA'];
var facts2 = ['TRANCADA','PARA OS HOLDS','BLOQUEADAS','ANTI WHALE','DO MARKETING','ANTI RUG','+TRANSPARÊNCIA'];
var factsgot = ['',''];
var num = 0;
