...
var facts = ['50% LIQUIDEZ','10% FEE','BILLETERAS DEVS','PROYECTO','MARKETING','PROYECTO','+CONFIANZA'];
var facts2 = ['BLOQUEADA','PARA HOLDERS','BLOQUEADAS','ANTI WHALE','CONTINUO','ANTI RUG','+TRANSPARENCIA'];
var factsgot = ['',''];
var num = 0;
